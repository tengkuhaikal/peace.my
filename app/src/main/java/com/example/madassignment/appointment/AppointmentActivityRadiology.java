...
public class AppointmentActivityRadiology extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.appointment_activity_radiology);
        ...
        radiology1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent it = new Intent(AppointmentActivityRadiology.this, AppointmentActivityDateAndTime.class);
